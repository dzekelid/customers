...
- name: Akamai API Modify a Customer
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/customers/master/_listings/akamai/config-saas-registration-v1-customers-surrogateid-put.md
x-common:
- type: x-base
