...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/customers/master/_listings/akamai/galaxy-v1-customers-akamaicustomerid-op-deactivate-post.md
x-common:
- type: x-base
