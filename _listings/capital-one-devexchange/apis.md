...
- name: Capital One DevExchange - Get customer that owns the specified account
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/customers/master/_listings/capital-one-devexchange/accountsidcustomer-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/customers/master/_listings/capital-one-devexchange/accountsidcustomer-get-openapi.md
- name: Capital One DevExchange - Get customer that owns the specified account
  x-api-slug: accountsidcustomer-get
  description: Returns the customer that the account belongs to.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/capitalone-devexchange.png
