...
- name: Stripe Get Customers Customer Subscriptions Subscription Exposed  Discount
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/customers/master/_listings/stripe/customers-customer-subscriptions-subscription-exposed-id-discount-get-postman.md
x-common:
- type: x-base
