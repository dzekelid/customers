...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/customers/master/_listings/versapay/apis.md
...
- name: VersaPay API Reference - Create and Update Customer
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/customers/master/_listings/versapay/apiimportscustomer-post-openapi.md
- name: VersaPay API Reference - Create and Update Customer
  x-api-slug: apiimportscustomer-post
  description: |-
    Create a customer in ARC using the following attributes (at minimum by providing values for required attributes). If providing an identifier for an existing customer, its information is updated.<br><br>
...
- name: VersaPay API Reference - Create and Update Invoice
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/customers/master/_listings/versapay/apiimportsinvoice-post-openapi.md
- name: VersaPay API Reference - Create a Payment
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/customers/master/_listings/versapay/apiimportspayment-post-openapi.md
- name: VersaPay API Reference - Create and Update Customer
  x-api-slug: apiimportscustomer-post
  description: |-
    Create a customer in ARC using the following attributes (at minimum by providing values for required attributes). If providing an identifier for an existing customer, its information is updated.<br><br>
