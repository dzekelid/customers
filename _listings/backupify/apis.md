...
- name: Backupify - A simple method to test authentication of a customer access token.
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/customers/master/_listings/backupify/v1authenticate-customer-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/customers/master/_listings/backupify/v1authenticate-customer-get-openapi.md
- name: Backupify - Retrieves the customer identified by customer_id
  x-api-slug: v1customerscustomer-id-get
  description: Requires Access Token granted from client credentials.
  image: ""
