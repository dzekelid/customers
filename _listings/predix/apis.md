...
created: "2018-08-26"
modified: "2018-08-26"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/customers/master/_listings/predix/apis.md
...
- name: Dynamic Mapping - List all asset collections for a customer
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/customers/master/_listings/predix/v1collections-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/customers/master/_listings/predix/v1collections-get-openapi.md
- name: Dynamic Mapping - List all asset collections for a customer
  x-api-slug: v1collections-get
  description: |-
    Returns an array containing the names of all asset collections for the
